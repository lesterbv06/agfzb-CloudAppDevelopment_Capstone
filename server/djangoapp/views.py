...
def get_dealerships(request):
    context = {}
    if request.method == "GET":
        url = 'https://854337d4.us-south.apigw.appdomain.cloud/dealership/dealership/dealer-get'
...
def get_dealer_details(request, dealer_id):
    context = {}
    if request.method == "GET":
        url = 'https://854337d4.us-south.apigw.appdomain.cloud/api/review/review-get'
...
def add_review(request, dealer_id):
    if request.method == "GET":
        dealersid = dealer_id
        #url = 'https://854337d4.us-south.apigw.appdomain.cloud/api/dealerships/dealer-get?dealerId={0}".format(dealersid)
        # Get dealers from the URL
        context = {
    ...
    if request.method == "POST":
        if request.user.is_authenticated:
            ...
            print (json_payload)
            #url = 'https://854337d4.us-south.apigw.appdomain.cloud/api/dealerships/reviews/review-post"
